...
def main():
    get_results_arylation('ligand')

    # ligands, average, results = get_results_suzuki(components=['base', 'ligand'], short=False, cutoff=0.7)
...
def get_results_arylation(components, short=False, cutoff=None):
    raw = pd.read_csv('../data/arylation/experiment_index.csv')
    print(raw.columns)
    return None
